	...
	function cg_class(thingId)
    	...
    	$('#but_mercure').hover(
	       function(){ $("#mercure-orbit").css('border', '10px solid white');
	       	       $(".info_sys").css('display', 'none');
	       	       $(".info_mercure").css('display', '');
	       },
	       function(){ $("#mercure-orbit").css('border', '2px dotted white');
	       	       $(".info_sys").css('display', '');
	       	       $(".info_mercure").css('display', 'none');
	       }
       );
       $('#but_venus').hover(
	       function(){ $("#venus-orbit").css('border', '10px solid white'); 
	       	       $(".info_sys").css('display', 'none');
	       	       $(".info_venus").css('display', '');
	       },
	       function(){ $("#venus-orbit").css('border', '2px dotted white'); 
	       	       $(".info_sys").css('display', '');
	       	       $(".info_venus").css('display', 'none');
	       }
       );
       $('#but_earth').hover(
	       function(){ $("#earth-orbit").css('border', '10px solid white'); 
	       	       $(".info_sys").css('display', 'none');
	       	       $(".info_earth").css('display', '');
	       },
	       function(){ $("#earth-orbit").css('border', '2px dotted white'); 
	       	       $(".info_sys").css('display', '');
	       	       $(".info_earth").css('display', 'none');
	       }
       );
       $('#but_lune').hover(
	       function(){ $("#lune-orbit").css('border', '10px solid white'); 
	       	       $(".info_sys").css('display', 'none');
	       	       $(".info_lune").css('display', '');
	       },
	       function(){ $("#lune-orbit").css('border', '2px dotted white'); 
	       	       $(".info_sys").css('display', '');
	       	       $(".info_lune").css('display', 'none');
	       }
       );
       $('#but_mars').hover(
	       function(){ $("#mars-orbit").css('border', '10px solid white'); 
	       	       $(".info_sys").css('display', 'none');
	       	       $(".info_mars").css('display', '');
	       },
	       function(){ $("#mars-orbit").css('border', '2px dotted white'); 
	       	       $(".info_sys").css('display', '');
	       	       $(".info_mars").css('display', 'none');
	       }
       );
       $('#but_jupiter').hover(
	       function(){ $("#jupiter-orbit").css('border', '20px solid white'); 
	       	       $(".info_sys").css('display', 'none');
	       	       $(".info_jupiter").css('display', '');
	       },
	       function(){ $("#jupiter-orbit").css('border', '2px dotted white'); 
	       	       $(".info_sys").css('display', '');
	       	       $(".info_jupiter").css('display', 'none');
	       }
       );
       $('#but_saturne').hover(
	       function(){ $("#saturne-orbit").css('border', '20px solid white'); 
	       	       $(".info_sys").css('display', 'none');
	       	       $(".info_saturne").css('display', '');
	       },
	       function(){ $("#saturne-orbit").css('border', '2px dotted white'); 
	       	       $(".info_sys").css('display', '');
	       	       $(".info_saturne").css('display', 'none');
	       }
       );
       $('#but_uranus').hover(
	       function(){ $("#uranus-orbit").css('border', '20px solid white'); 
	       	       $(".info_sys").css('display', 'none');
	       	       $(".info_uranus").css('display', '');
	       },
	       function(){ $("#uranus-orbit").css('border', '3px dotted white'); 
	       	       $(".info_sys").css('display', '');
	       	       $(".info_uranus").css('display', 'none');
	       }
       );
       $('#but_neptune').hover(
	       function(){ $("#neptune-orbit").css('border', '20px solid white'); 
	       	       $(".info_sys").css('display', 'none');
	       	       $(".info_neptune").css('display', '');
	       },
	       function(){ $("#neptune-orbit").css('border', '4px dotted white'); 
	       	       $(".info_sys").css('display', '');
